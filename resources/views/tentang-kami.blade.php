...
@section('title', 'Tentang Kami - Graha Permata Jingga')
...
@push('styles')
    <style>
        .page-hero {
            height: 60vh;
            min-height: 400px;
            background-image: url('{{ $page->image ? (str_starts_with($page->image, "static/") ? asset($page->image) : asset("storage/" . $page->image)) : asset("static/image/tentang_kami.png") }}');
...
@section('content')
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content text-white">
            ...
            <h1 class="display-2 fw-bold font-serif mb-0" style="letter-spacing: 10px;">TENTANG KAMI</h1>
        </div>
    </section>
