...
<head>
    ...
    <title>Berita - Graha Permata Jingga</title>
    <link rel="icon" type="image/png" href="static/image/logo.png">

    <!-- CMS (WordPress + Elementor Match) -->
    <meta name="generator" content="WordPress 6.1.5" />
    <meta name="generator" content="Elementor 3.32.4; uri: https://elementor.com" />
    ...
    <style>
        ...
        .navbar-luxury.scrolled .brand-text-sub { color: #222 !important; }

        /* Hero Section */
        .news-hero {
            height: 60vh;
            min-height: 400px;
            background-image: url('static/image/berita.png');
        ...
        .nav-minimal:hover, .nav-minimal:active {
...
<body>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="offcanvasMobileMenu"
        ...
        <div class="offcanvas-body p-4 pt-2 d-flex flex-column h-100">
            ...
            <div class="mobile-nav-list mb-auto">
                ...
                <a class="nav-minimal active" href="{{ url('berita') }}">BERITA</a>
    ...
    <section class="news-hero">
        ...
        <div class="news-hero-content">
            <h1 class="news-hero-title">Berita</h1>
        </div>
    </section>
    ...
    <section class="py-5 bg-light">
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-12 text-center mb-4">
                    <div class="d-flex justify-content-center align-items-center mb-2">
                        <span
                            style="color: #E67E22; letter-spacing: 5px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase;">Graha
                            Permata Jingga</span>
                    </div>
                    <h2 class="font-serif" style="font-size: 2.5rem; color: #222;">Update Terbaru Kami</h2>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 reveal">
                    <div class="news-card">
                        <div class="news-card-img-wrap">
                            <div class="news-badge">Berita Terbaru</div>
                            <img src="{{ $post->image ? (str_starts_with($post->image, 'static/') ? asset($post->image) : asset('storage/' . $post->image)) : asset('static/image/berita1.png') }}" alt="{{ $post->title }}">
                        </div>
                        <div class="news-content">
                            <span class="news-date"><i class="far fa-calendar-alt me-2"></i>{{ \Carbon\Carbon::parse($post->published_at ?: $post->created_at)->format('d F Y') }}</span>
                            <h3 class="news-title">{{ $post->title }}</h3>
                            <div style="width: 50px; height: 3px; background: #E67E22; margin-top: -5px; margin-bottom: 15px; border-radius: 2px;"></div>
                            <div class="news-excerpt">
                                {!! strip_tags($post->content) !!}
                            </div>
                            <a href="#" class="btn-read-more">Baca Selengkapnya <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                @empty
            ...
            <style>
                ...
                .pagination-wrapper nav > div:first-child:not([class*="pagination"]) {
                    display: none !important;
                }
                /* Target Laravel's default structure to hide info more safely */
        ...
        <div class="container position-relative" style="z-index: 2; padding: 100px 0 0;">
            ...
            <div class="text-center py-4" style="border-top: 1px solid rgba(230,126,34,0.15);">
                <p style="color: rgba(255,255,255,0.4); font-size: 0.8rem; margin: 0; letter-spacing: 1px;">
                    &copy; 2026 <span style="color: #E67E22; font-weight: 700;">Graha Permata Jingga</span> Ã¢â‚¬â€œ All rights
                    reserved. |
    ...
    <script>
        ...
        window.addEventListener('scroll', function () {
            ...
            if (window.scrollY > 100) {
                ...
                document.querySelector('.navbar-toggler i').style.color = '#E67E22';
            } else {
                nav.classList.remove('scrolled');
                document.querySelector('.navbar-toggler i').style.color = '#fff';
            }
        });
